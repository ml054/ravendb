...
import saveDatabaseSettingsCommand from "commands/database/settings/saveDatabaseSettingsCommand";
...
import saveDatabaseSettingsConfirm from "viewmodels/database/settings/saveDatabaseSettingsConfirm";
import * as models from "models/database/settings/databaseSettingsModels";
