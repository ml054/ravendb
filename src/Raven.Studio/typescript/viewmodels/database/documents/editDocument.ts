...
import cloneRelatedItemsCommand from "commands/database/documents/cloneRelatedItemsCommand";
import getDocumentWithMetadataCommand from "commands/database/documents/getDocumentWithMetadataCommand";
import getDocumentPhysicalSizeCommand from "commands/database/documents/getDocumentPhysicalSizeCommand";
import getDocumentsFromCollectionCommand from "commands/database/documents/getDocumentsFromCollectionCommand";
import getRevisionsBinDocumentMetadataCommand from "commands/database/documents/getRevisionsBinDocumentMetadataCommand";
import generateClassCommand from "commands/database/documents/generateClassCommand";
import getCountersCommand from "commands/database/documents/counters/getCountersCommand";
import setCounterDialog from "viewmodels/database/documents/setCounterDialog";
import appUrl from "common/appUrl";
import viewHelpers from "common/helpers/view/viewHelpers";
import jsonUtil from "common/jsonUtil";
import messagePublisher from "common/messagePublisher";
import aceEditorBindingHandler from "common/bindingHelpers/aceEditorBindingHandler";
import deleteCounterCommand from "commands/database/documents/counters/deleteCounterCommand";
...
import deleteAttachmentCommand from "commands/database/documents/attachments/deleteAttachmentCommand";
import setCounterCommand from "commands/database/documents/counters/setCounterCommand";
...
import connectedDocuments from "viewmodels/database/documents/editDocumentConnectedDocuments";
import getDocumentAtRevisionCommand from "commands/database/documents/getDocumentAtRevisionCommand";
...
import getDocumentRevisionsCommand from "commands/database/documents/getDocumentRevisionsCommand";
import getDocumentRevisionsCountCommand from "commands/database/documents/getDocumentRevisionsCountCommand";
import editorWarningsConfirm from "viewmodels/database/documents/editorWarningsConfirm";
import forceRevisionCreationCommand from "commands/database/documents/forceRevisionCreationCommand";
import getTimeSeriesStatsCommand from "commands/database/documents/timeSeries/getTimeSeriesStatsCommand";
