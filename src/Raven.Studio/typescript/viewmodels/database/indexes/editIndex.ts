...
import autoIndexDefinition from "models/database/index/autoIndexDefinition";
import getIndexDefinitionCommand from "commands/database/index/getIndexDefinitionCommand";
import getCSharpIndexDefinitionCommand from "commands/database/index/getCSharpIndexDefinitionCommand";
...
import indexAceAutoCompleteProvider from "models/database/index/indexAceAutoCompleteProvider";
import deleteIndexesConfirm from "viewmodels/database/indexes/deleteIndexesConfirm";
import saveIndexDefinitionCommand from "commands/database/index/saveIndexDefinitionCommand";
import detectIndexTypeCommand from "commands/database/index/detectIndexTypeCommand";
import indexFieldOptions from "models/database/index/indexFieldOptions";
import getIndexFieldsFromMapCommand from "commands/database/index/getIndexFieldsFromMapCommand";
...
import getIndexHistoryCommand from "commands/database/index/getIndexHistoryCommand";
import eventsCollector from "common/eventsCollector";
import showDataDialog from "viewmodels/common/showDataDialog";
import formatIndexCommand from "commands/database/index/formatIndexCommand";
...
import mapIndexSyntax from "viewmodels/database/indexes/mapIndexSyntax";
import fileDownloader from "common/fileDownloader";
import mapReduceIndexSyntax from "viewmodels/database/indexes/mapReduceIndexSyntax";
import additionalSourceSyntax from "viewmodels/database/indexes/additionalSourceSyntax";
import additionalAssemblySyntax from "viewmodels/database/indexes/additionalAssemblySyntax";
import fileImporter from "common/fileImporter";
import popoverUtils from "common/popoverUtils";
import dumpDialog from "viewmodels/database/indexes/dumpDialog";
...
import getIndexDefaultsCommand from "commands/database/index/getIndexDefaultsCommand";
