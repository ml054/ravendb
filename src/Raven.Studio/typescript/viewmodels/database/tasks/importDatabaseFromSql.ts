...
import migrateSqlDatabaseCommand from "commands/database/tasks/migrateSqlDatabaseCommand";
import testSqlMigrationCommand from "commands/database/tasks/testSqlMigrationCommand";
...
import referenceUsageDialog from "viewmodels/database/tasks/referenceUsageDialog";
