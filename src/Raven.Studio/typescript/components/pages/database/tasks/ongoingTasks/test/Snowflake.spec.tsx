...
import * as stories from "components/pages/database/tasks/ongoingTasks/stories/Snowflake.stories";
...
const containerTestId = "snowflake-etls";
...
describe("Snowflake", function () {
    it("can render disabled and not completed", async () => {
        ...
        expect(await container.findByText(/Snowflake ETL/)).toBeInTheDocument();
        ...
        const target = await container.findByText("Snowflake-CS");
