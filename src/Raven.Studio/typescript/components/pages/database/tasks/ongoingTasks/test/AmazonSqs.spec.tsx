...
import * as stories from "components/pages/database/tasks/ongoingTasks/stories/AmazonSqs.stories";
...
const containerTestId = "amazon-sqs-etls";
...
describe("Amazon SQS ETL", function () {
    it("can render disabled and not completed", async () => {
        ...
        expect(await container.findByText(/AMAZON SQS ETL/)).toBeInTheDocument();
